...
class _CalculatorScreenState extends CalculatorController<CalculatorScreen> {
  String _metal = 'Gold';
  String _purity = '24K';
  double _grams = 10.0;
  ...
  double get _rate => getRate(_metal, _purity);
  double get _total => calculateTotal(_metal, _purity, _grams);
  ...
  Widget build(BuildContext context) {
    final purities = getPurities(_metal);
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(
                  'Estimated Value (USD)',
                  style: GoogleFonts.cinzel(fontSize: 11, color: Colors.grey),
                ),
          ...
          ElevatedButton(
            ...
            child: Text(
              _metal == 'Gold' ? 'Live Gold Market' : 'Live Silver Market',
            ),
          ),
        ],
      ),
